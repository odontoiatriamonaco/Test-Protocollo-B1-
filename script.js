...
function mostraSintesiPreparazione() {
    try {
        ...
        html += '<div style="display:flex; justify-content:center; gap:12px; font-size:9px; color:#666; margin:5px 0 10px 0; padding:5px; background:#f9f9f9; border-radius:4px;">';
        html += '<span style="font-weight:bold;">Legenda:</span>';
        html += '<span style="display:flex;align-items:center;gap:2px;"><span style="width:8px;height:8px;background:#ffcdd2;border:1px solid #999;border-radius:50%"></span>D1</span>';
        html += '<span style="display:flex;align-items:center;gap:2px;"><span style="width:8px;height:8px;background:#ffe0b2;border:1px solid #999;border-radius:50%"></span>D2</span>';
        html += '<span style="display:flex;align-items:center;gap:2px;"><span style="width:8px;height:8px;background:#fff9c4;border:1px solid #999;border-radius:50%"></span>D3</span>';
        html += '<span style="display:flex;align-items:center;gap:2px;"><span style="width:8px;height:8px;background:#c8e6c9;border:1px solid #999;border-radius:50%"></span>D4</span>';
        html += '</div>';
        ...
        function generaFlussoCompatto(items, nomeArcata, colore) {
            ...
            for (var idx = 0; idx < tuttiDiametri.length; idx++) {
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    if (includiDente) {
                        dentiConQuestoDiametro.push({
                            dente: item.dente,
                            lunghezza: lunghezzaPerQuestoDiam || (item.impLen + "mm"),
                            item: item
                        });
                    }
            ...
            if (headPrepItems.length > 0) {
                ...
                flussoHTML += '<div style="font-weight:bold; font-size:15px; color:#856404;">🟢 Preparazione Testa</div>';
